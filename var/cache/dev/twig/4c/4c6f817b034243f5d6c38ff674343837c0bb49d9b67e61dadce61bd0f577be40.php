...
/* base.html.twig */
class __TwigTemplate_9f569feda79cc9c1d17cb70e83c84b97684765649d3ba43d0bfb6e981cdb303b extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light pt-3  \">
      <div class=\"container-fluid\">
        ...
        if (array_key_exists("name", $context)) {
            echo " ";
            if ((0 === twig_compare((isset($context["name"]) || array_key_exists("name", $context) ? $context["name"] : (function () { throw new RuntimeError('Variable "name" does not exist.', 24, $this->source); })()), "students"))) {
                echo " active ";
            }
            echo "  ";
        }
        ...
        if (array_key_exists("name", $context)) {
            echo " ";
            if ((0 === twig_compare((isset($context["name"]) || array_key_exists("name", $context) ? $context["name"] : (function () { throw new RuntimeError('Variable "name" does not exist.', 30, $this->source); })()), "Courses"))) {
                echo " active ";
            }
            echo "  ";
        }
    ...
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light pt-3  \">
      <div class=\"container-fluid\">
        ...
        <div class=\"collapse navbar-collapse justify-content-lg-end\" style=\"margin-right:3%!important\"  id=\"navbar\">
            <ul class=\"navbar-nav \">
                <li class=\"nav-item\">
                   <a class=\"nav-link  font-weight-bold {% if name is defined %} {% if name == 'students' %} active {%endif%}  {%endif%} \" aria-current=\"page\" href=\"{{ path('Student',{'st':'students'}) }}\"><h6>Students</h6></a>
                </li>
                <li class=\"nav-item\">
                ...
                <li class=\"nav-item\">
                    <a class=\"nav-link font-weight-bold {% if name is defined %} {% if name == 'Courses' %} active {%endif%}  {%endif%}\" href=\"{{ path('Student',{'st':'Courses'}) }}\"><h6>Courses</h6></a>
                </li>
            </ul>
        </div>
      </div>
