...
class __TwigTemplate_225cdcc231132000c17c8bad2d40713714dce6d84e53a5eed31658e9d7edfdaf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(sprintf((isset($context["value_format"]) || array_key_exists("value_format", $context) ? $context["value_format"] : (function () { throw new RuntimeError('Variable "value_format" does not exist.', 18, $this->source); })()), (isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 18, $this->source); })())), [], (isset($context["translation_domain"]) || array_key_exists("translation_domain", $context) ? $context["translation_domain"] : (function () { throw new RuntimeError('Variable "translation_domain" does not exist.', 18, $this->source); })())), "html", null, true);
        echo "
";
    ...
    {
        return array (  76 => 18,  73 => 17,  70 => 16,  67 => 15,  57 => 14,  35 => 12,);
    }
...
{% endblock %}
", "@SonataAdmin/CRUD/list_trans.html.twig", "C:\\Users\\farha\\OneDrive\\Desktop\\projet\\ob_soft\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\list_trans.html.twig");
    }
}
