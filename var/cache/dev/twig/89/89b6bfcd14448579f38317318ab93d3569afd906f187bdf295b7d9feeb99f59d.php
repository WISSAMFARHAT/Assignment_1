...
class __TwigTemplate_a883948678c691c36a0ad6b680611ab15759ba3c40d86ff87a03212342c5d77f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_block($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 16
            echo "        ";
            $context["display"] = ((twig_test_empty(twig_get_attribute($this->env, $this->source, $context["group"], "roles", [], "any", false, false, false, 16)) || $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted(twig_get_attribute($this->env, $this->source, (isset($context["sonata_config"]) || array_key_exists("sonata_config", $context) ? $context["sonata_config"] : (function () { throw new RuntimeError('Variable "sonata_config" does not exist.', 16, $this->source); })()), "getOption", [0 => "role_super_admin"], "method", false, false, false, 16))) || (1 === twig_compare(twig_length_filter($this->env, twig_array_filter($this->env, twig_get_attribute($this->env, $this->source, $context["group"], "roles", [], "any", false, false, false, 16), function ($__role__) use ($context, $macros) { $context["role"] = $__role__; return $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted((isset($context["role"]) || array_key_exists("role", $context) ? $context["role"] : (function () { throw new RuntimeError('Variable "role" does not exist.', 16, $this->source); })())); })), 0)));
            // line 17
            echo "
        ";
            // line 18
            if ((isset($context["display"]) || array_key_exists("display", $context) ? $context["display"] : (function () { throw new RuntimeError('Variable "display" does not exist.', 18, $this->source); })())) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                    // line 27
                    echo "                                ";
                    if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["admin"], "dashboardActions", [], "any", false, false, false, 27)), 0))) {
                        // line 28
                        echo "                                    <tr>
                                        <td class=\"sonata-ba-list-label\" width=\"40%\">
                                            ";
                        // line 30
                        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["admin"], "label", [], "any", false, false, false, 30))) {
                            // line 31
                            echo "                                                ";
                            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, $context["admin"], "label", [], "any", false, false, false, 31), [], twig_get_attribute($this->env, $this->source, $context["admin"], "translationdomain", [], "any", false, false, false, 31)), "html", null, true);
                            echo "
                                            ";
                        }
                        // line 33
                        ...
                        // line 36
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["admin"], "dashboardActions", [], "any", false, false, false, 36));
                        $context['loop'] = [
                          'parent' => $context['_parent'],
                          'index0' => 0,
                          'index'  => 1,
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                            // line 37
                            echo "                                                    ";
                            $this->loadTemplate(((twig_get_attribute($this->env, $this->source, $context["action"], "template", [], "any", true, true, false, 37)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, $context["action"], "template", [], "any", false, false, false, 37), "@SonataAdmin/CRUD/dashboard__action.html.twig")) : ("@SonataAdmin/CRUD/dashboard__action.html.twig")), "@SonataAdmin/Block/block_admin_list.html.twig", 37)->display(twig_array_merge($context, ["action" => $context["action"]]));
                            // line 38
                            echo "                                                ";
                            ++$context['loop']['index0'];
                            ++$context['loop']['index'];
    ...
    {
        return array (  203 => 49,  196 => 44,  182 => 43,  176 => 39,  162 => 38,  159 => 37,  142 => 36,  137 => 33,  131 => 31,  129 => 30,  125 => 28,  122 => 27,  105 => 26,  97 => 21,  93 => 19,  91 => 18,  88 => 17,  85 => 16,  67 => 15,  57 => 14,  35 => 12,);
    }
...
{% block block %}
    ...
    {% endfor %}
{% endblock %}
", "@SonataAdmin/Block/block_admin_list.html.twig", "C:\\Users\\farha\\OneDrive\\Desktop\\projet\\ob_soft\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Block\\block_admin_list.html.twig");
    }
}
