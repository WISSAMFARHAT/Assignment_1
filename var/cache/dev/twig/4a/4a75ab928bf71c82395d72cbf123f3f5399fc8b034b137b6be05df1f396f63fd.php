...
class __TwigTemplate_ee6c19cc58c1e2d4f83d34a9c14099292be102cb91d72c0a4babd9380553f205 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"field_container_";
        ...
        <span id=\"field_widget_";
            ...
            ";
            // line 19
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 19, $this->source); })()), "edit", [], "any", false, false, false, 19), "inline"))) {
                // line 20
                echo "                ";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 20, $this->source); })()), "inline", [], "any", false, false, false, 20), "table"))) {
                    // line 21
                    echo "                    ";
                    if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "children", [], "any", false, false, false, 21)), 0))) {
                        // line 22
                        echo "                        ";
                    ...
                    // line 24
                    echo "                ";
                } elseif ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "children", [], "any", false, false, false, 24)), 0))) {
                    // line 25
                    echo "                    ";
...
($context["sonata_admin"] ?? null), "field_description", [], "any", false, true, false, 39), "options", [], "any", false, true, false, 39), "limit", [], "any", true, true, false, 39) || (-1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source,             // line 40
(isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 40, $this->source); })()), "children", [], "any", false, false, false, 40)), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 40, $this->source); })()), "field_description", [], "any", false, false, false, 40), "options", [], "any", false, false, false, 40), "limit", [], "any", false, false, false, 40)))));
        ...
        ";
            // line 43
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 43, $this->source); })()), "edit", [], "any", false, false, false, 43), "inline"))) {
                // line 44
                echo "
            ";
                // line 45
...
(isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 50, $this->source); })()), "field_description", [], "any", false, false, false, 50), "getOption", [0 => "link_parameters", 1 => []], "method", false, false, false, 50)], "method", false, false, false, 48), "html", null, true);
            ...
            ";
                ...
                if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["sonata_admin"] ?? null), "field_description", [], "any", false, true, false, 63), "options", [], "any", false, true, false, 63), "sortable", [], "any", true, true, false, 63)) {
                    // line 64
                    echo "                ";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 64, $this->source); })()), "inline", [], "any", false, false, false, 64), "table"))) {
                        // line 65
                        echo "                    ";
...
{% endif %}
", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", "C:\\Users\\farha\\OneDrive\\Desktop\\projet\\ob_soft\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\Association\\edit_one_to_many.html.twig");
    }
}
