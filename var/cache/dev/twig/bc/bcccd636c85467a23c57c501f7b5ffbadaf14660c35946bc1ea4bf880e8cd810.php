...
class __TwigTemplate_a90b496fda87ef15e8d9155c29cc9cee4f8486a0d476a4189a352851619d9bed extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "flashes", [0 => "done"], "method", false, false, false, 11));
...
<thead>
  ...
  ";
        // line 27
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["course"]) || array_key_exists("course", $context) ? $context["course"] : (function () { throw new RuntimeError('Variable "course" does not exist.', 27, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["show"]) {
            // line 28
            echo "  <form action=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("new_student_course", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 28, $this->source); })())]), "html", null, true);
            echo "\">
    <tr>
...
";
    ...
    {
        return array (  183 => 45,  172 => 40,  168 => 38,  157 => 36,  153 => 35,  147 => 32,  143 => 31,  139 => 30,  133 => 28,  129 => 27,  116 => 16,  107 => 13,  104 => 12,  100 => 11,  93 => 7,  88 => 4,  78 => 3,  59 => 2,  36 => 1,);
    }
