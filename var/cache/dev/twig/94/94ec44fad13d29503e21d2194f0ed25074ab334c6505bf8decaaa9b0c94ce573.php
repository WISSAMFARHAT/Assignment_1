...
class __TwigTemplate_b601903ad523abd23bcac6494404ad08cf90b9301f6f79d9841bc5fef863a309 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_list_table($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["context"]) {
            ...
            echo "\">
                                        ";
            // line 62
            if (((isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 62, $this->source); })()) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["context"], "id", [], "any", false, false, false, 62), twig_get_attribute($this->env, $this->source, (isset($context["currentContext"]) || array_key_exists("currentContext", $context) ? $context["currentContext"] : (function () { throw new RuntimeError('Variable "currentContext" does not exist.', 62, $this->source); })()), "id", [], "any", false, false, false, 62))))) {
                // line 63
...
{% endblock %}
", "@SonataAdmin/CRUD/tree.html.twig", "C:\\Users\\farha\\OneDrive\\Desktop\\projet\\ob_soft\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\tree.html.twig");
    }
}
