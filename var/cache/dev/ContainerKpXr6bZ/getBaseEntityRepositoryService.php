 ...
 */
class getBaseEntityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BaseEntityRepository' shared autowired service.
     *
     * @return \App\Repository\BaseEntityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BaseEntityRepository.php';

        return $container->privates['App\\Repository\\BaseEntityRepository'] = new \App\Repository\BaseEntityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
