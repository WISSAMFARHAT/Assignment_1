 ...
 */
class getAdmin_StudentService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'admin.student' autowired service.
     *
     * @return \App\Admin\StudentAdmin
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'StudentAdmin.php';
        ...
        $container->factories['admin.student'] = function () use ($container) {
            $instance = new \App\Admin\StudentAdmin('admin.student', 'App\\Entity\\Student', 'sonata.admin.controller.crud');
            ...
            $instance->setLabel('Student');
            $instance->showMosaicButton(true);
            $instance->setTemplateRegistry(($container->services['admin.student.template_registry'] ?? $container->load('getAdmin_Student_TemplateRegistryService')));
        ...
        return $container->factories['admin.student']();
    }
}
