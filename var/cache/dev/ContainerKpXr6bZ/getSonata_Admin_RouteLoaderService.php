...
class getSonata_Admin_RouteLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader(($container->services['sonata.admin.pool'] ?? $container->getSonata_Admin_PoolService()), [0 => 'admin.student', 1 => 'admin.clase', 2 => 'admin.course', 3 => 'admin.students_grade', 4 => 'admin.base_entity'], $container);
    }
}
