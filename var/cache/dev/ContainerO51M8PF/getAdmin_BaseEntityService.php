 ...
 */
class getAdmin_BaseEntityService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'admin.base_entity' autowired service.
     *
     * @return \App\Admin\BaseEntityAdmin
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'BaseEntityAdmin.php';
        ...
        $container->factories['admin.base_entity'] = function () use ($container) {
            $instance = new \App\Admin\BaseEntityAdmin('admin.base_entity', 'App\\Entity\\BaseEntity', 'sonata.admin.controller.crud');
            ...
            $instance->setLabel('BaseEntity');
            $instance->showMosaicButton(true);
            $instance->setTemplateRegistry(($container->services['admin.base_entity.template_registry'] ?? $container->load('getAdmin_BaseEntity_TemplateRegistryService')));
        ...
        return $container->factories['admin.base_entity']();
    }
}
