...
class getTranslation_ExtractorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtractor('sonata_admin', new \Sonata\AdminBundle\Translator\Extractor\AdminExtractor(($container->services['sonata.admin.pool'] ?? $container->getSonata_Admin_PoolService()), ($container->services['sonata.admin.breadcrumbs_builder'] ?? $container->load('getSonata_Admin_BreadcrumbsBuilderService'))));
