 ...
 */
class getAdmin_ClaseService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'admin.clase' autowired service.
     *
     * @return \App\Admin\ClaseAdmin
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'ClaseAdmin.php';
        ...
        $container->factories['admin.clase'] = function () use ($container) {
            $instance = new \App\Admin\ClaseAdmin('admin.clase', 'App\\Entity\\Clase', 'sonata.admin.controller.crud');
            ...
            $instance->setLabel('Clase');
            $instance->showMosaicButton(true);
            $instance->setTemplateRegistry(($container->services['admin.clase.template_registry'] ?? $container->load('getAdmin_Clase_TemplateRegistryService')));
        ...
        return $container->factories['admin.clase']();
    }
}
