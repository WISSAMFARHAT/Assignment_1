...
class AdminController extends AbstractController
{
    ...
    public function New(String $name,Request $request)
    {
      ...
      /**
     * @Route("/student/edit/{id}",name="update")
     */
    ...
    /**
     * @Route("/student/Remove/{id}",name="Remove")
     */
    ...
    /**
     * @Route("/student/new_course/{id}",name="new_course")
     */
    public function new_course(int $id,Request $request)
    {
     ...
     /**
     * @Route("/student/new_student_course/{id}",name="new_student_course")
     */
    ...
    /**
     * @Route("/classes/edit/{id}",name="update_classes")
     */
    ...
    return $this->render('students/cl_insert_update.html.twig',array("name"=>"Update","Page"=>'Classes','image'=>$Class,'id'=>$id,'editForm'=>$form->createView()));
       ...
       /**
     * @Route("/classes/{name}",name="insert_classes")
     */
    ...
    /**
     * @Route("/classes/Remove/{id}",name="Remove_classes")
     */
    ...
    /**
     * @Route("/Courses/edit/{id}",name="update_course")
     */
    ...
    /**
     * @Route("/Courses/Remove/{id}",name="Remove_course")
     */
    public function Remove_Course(int $id,PaginatorInterface $paginator,Request $request):Response
    {
     ...
     /**
     * @Route("/{student}/{filter}",name="Filter")
     */
